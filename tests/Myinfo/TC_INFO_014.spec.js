...
test('TC_MyInfo_014:  : Add Emergency Contact Missing Required Field (Negative)', async () => {
    ...
    await myInfo.enterInputByIndex(5, "03070586297");
    await adminEducation.clickSaveButton();
    await myInfo.verifyFieldMissingError();
});