...
test('TC_PERFORMANCE_067 - Search Employee Performance Trackers by Employee Name', async({page})=>{
    ...
    await performance.searchonEmployeeTracker('Current and Past Employees');
});