...
test('TC_PERFORMANCE_066 - Verify Employee Performance Trackers UI Elements and Table Columns', async ({ page }) => {
    await performance.clickperformanceTab();
    await performance.verifyPerformancePage();
    await adminOrganization.clickTopMenu('Employee Trackers');
