...
test('TC_INFO_028 - Verify Salary Details Display', async () => {
    await myInfo.clickMyInfoTab();
    await myInfo.verifyMyInfoPage();
    await myInfo.clickQualificationTab();
    await myInfo.clickAddExperienceTab();
    await myInfo.fillExperienceDetails('Company XYZ', 'Software Engineer');
