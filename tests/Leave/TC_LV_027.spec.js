...
test('TC_LV_027 - Generate ""Leave Entitlements and Usage Report"" by Employee', async () => {
    ...
    await leave.employeeUA();
    await leave.searchByEmployee('Rahul  Das');
    await leave.clickGenerate();
});