...
test('TC_Claim_012: Verify Filtering Employee Claims by "Include Current Employee Only"', async () => {
    ...
    await claim.enterEmployeeName("Swadhin");
    await claim.verifyIncludeOption("Current Employees Only");
